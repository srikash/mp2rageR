---
title: "Estimate M0 and T1 maps"
author: "Sriranga Kashyap"
date: "`r Sys.Date()`"
output: rmarkdown::pdf_document
vignette: >
  %\VignetteIndexEntry{Estimate M0 and T1 maps}
...
# MP2RAGE INV2
in_inv2 <- paste0(working_dir, "/MP2RAGE_INV2.nii.gz")
```
...
# MP2RAGE T1 map
out_t1 <-
  paste0(working_dir, "/MP2RAGE_Est_T1.nii.gz")

# MP2RAGE M0 map
out_m0 <-
  paste0(working_dir, "/MP2RAGE_Est_M0.nii.gz")
```
...
# Load NIfTI structure from UNI and write out M0 map
nii_m0 <- nii_uni
nii_m0@.Data <- list_of_t1_m0$m0_map
writenii(nim = nii_m0, filename = out_m0)
